...
import { copy, clearContents, getNode, getRandom, insertLast, isNumericString, showAlert } from "./lib/index.js";
...
function handleJujeob(e){
    ...
    if(!name || name.replace(/\s*/g,'') === ''){
        ...
        // 2초 뒤에 alert-error에게 is-active를 클래스 제거
