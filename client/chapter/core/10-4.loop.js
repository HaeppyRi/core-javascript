...
//-> 자바스크립트는 hasOwnProperty를 보호해주지 않습니다.⭐️
//-> 생성된 객체의 method는 불안함, => 진짜 객체(부모)의 능력을 빌려씀!!⭐️

//-> 메서드 빌려쓰기 (call)⭐️ -> 첫번째로 받는 대상이 불려오는 대상이 됨

//console.log( js.hasOwnProperty(key) );

console.log( Object.prototype.hasOwnProperty.call(js,key) );//⭐️
