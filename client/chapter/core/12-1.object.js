...
//프로퍼티 제거(remove 비워두기) vs 삭제(delete 없애버리기)
...
removeProperty(authUser,'uuid') // authUser.uuid = null; -> remove
...
// 순서는 바꿀 수 없음, 그러나 변수의 이름은 바꿀 수 있다.
...
//순서 상관 X, 변수의 이름 바꿀 수 있음!! (원래값:수정값)
//기본값을 지정할 수 있음!
...
const {박지성:박,김보미,이경민,전희선,도가현:도 = 20} = salaries;
